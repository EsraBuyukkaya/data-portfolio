...
`CerenceInc_20191002_8-K_EX-10.4_11827494_EX-10.4_Intellectual_Property_Agreement.txt`

## Summary

The review detected these key clauses: Governing Law, Termination, Confidentiality, Indemnification, Limitation of Liability. This is a rule-based portfolio prototype, so all results should be treated as a first-pass review rather than legal advice.

## Clause Checklist

| Clause Type | Status | Review Note |
|---|---|---|
| Governing Law | Found | Clause detected by keyword search. Review carefully because the keyword may appear outside the main clause heading. |
| Termination | Found | Clause detected by keyword search. Review carefully because the keyword may appear outside the main clause heading. |
| Confidentiality | Found | Clause detected by keyword search. Review carefully because the keyword may appear outside the main clause heading. |
| Indemnification | Found | Clause detected by keyword search. Review carefully because the keyword may appear outside the main clause heading. |
| Limitation of Liability | Found | Clause detected by keyword search. Review carefully because the keyword may appear outside the main clause heading. |
